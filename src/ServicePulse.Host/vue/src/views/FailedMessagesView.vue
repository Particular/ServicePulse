...
import FailedMesssageGroups from "../components/failedmessages/FailedMesssageGroups.vue";
...
const routes = {
  "failed-message-groups": {
    component: FailedMesssageGroups,
    title: "Failed Messsage Groups",
  },
  "all-failed-messages": {
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="tabs">
          ...
          <h5
            v-if="!licenseStatus.isExpired"
            :class="{ active: subIsActive('#all-deleted-messages') }"
          >

        ...
        <div class="col-sm-12">
          <div class="tabs">
            ...
            <h5
              ...
              :class="{
                active: subIsActive('all-failed-messages') || subIsActiveSubPath('/failed-messages/group/'),
                disabled: !connectionState.connected && !connectionState.connectedRecently,
              }"
            >
            ...
            <h5
              v-if="!licenseStatus.isExpired"
              :class="{
                active: subIsActive('all-deleted-messages') || subIsActiveSubPath('/deleted-messages/group/'),
                disabled: !connectionState.connected && !connectionState.connectedRecently,
              }"
            >

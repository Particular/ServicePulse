...
.pa-endpoint {
  position: relative;
  top: 3px;
  background-image: url("../a/img/endpoint.svg");
  background-position: center;
  background-repeat: no-repeat;
  height: 15px;
  width: 15px;
...
.pa-redirect-source {
  background-image: url("../a/img/redirect-source.svg");
  background-position: center;
  background-repeat: no-repeat;
}
...
.pa-redirect-destination {
  background-image: url("../a/img/redirect-destination.svg");
  background-position: center;
  background-repeat: no-repeat;
}
...
.btn-default.sp-btn-menu:focus,
.btn-default.focus.sp-btn-menu {
  background: none;
  border: none;
  color: #00a3c4;
  text-decoration: underline;
...
div.danger.sc-restart-warning,
div.danger.sc-restart-warning > i {
...
.versionnumber,
footer span.connection-failed.ng-scope {
  padding-right: 0;
}
...
#toast-container > .toast-error {
  background-image: url("../a/img/toast-danger.svg") !important;
...
#toast-container > .toast-warning {
  ...
  background-image: url("../a/img/toast-warning.svg") !important;
  background-position-y: 30px;
  background-size: 28px 28px;
}
...
.modal-msg-editor div[ng-show="message.panel === 1 && message.messageBody"],
.modal-msg-editor div[ng-show="message.panel === 1 && message.messageBody !== undefined && message.messageBody !== null"] {
...
.events-list .col-timestamp sp-moment {
  padding-top: 0;
  padding-bottom: 4px;
}
...
.pa-check {
  background-image: url("../a/img/check.svg");
}

.pa-uncheck {
  background-image: url("../a/img/uncheck.svg");
}
...
button[ng-click="vm.toggleSort()"] span {
  text-transform: uppercase;
}

button[ng-click="vm.toggleSort()"]:hover span {
  text-decoration: underline;
}

button[ng-click="vm.toggleSort()"] div {
  display: inline-block;
  margin-top: -1px;
}
...
.sort-up {
  background-image: url("../../a/img/sort-up.svg");
}
...
.pa-flow-saga {
  background-image: url("../a/img/saga.svg");
  background-position: center;
  background-repeat: no-repeat;
  height: 15px;
  width: 15px;
...
.pa-flow-timeout {
  background-image: url("../a/img/timeout.svg");
  background-position: center;
  background-repeat: no-repeat;
  height: 15px;
  width: 15px;
...
.pa-flow-event {
  background-image: url("../a/img/event.svg");
  background-position: center;
  background-repeat: no-repeat;
  height: 15px;
  width: 15px;
...
.pa-flow-command {
  background-image: url("../a/img/command.svg");
  background-position: center;
  background-repeat: no-repeat;
  height: 15px;
  width: 15px;
...
.pa-flow-failed {
  background-image: url("../a/img/failed-msg.svg");
  background-position: center;
  background-repeat: no-repeat;
  height: 15px;
  width: 15px;

        ...
        <div class="row">
          <div class="col-9">
            <div class="btn-toolbar">
              ...
              <button type="button" class="btn btn-default" @click="showConfirmRestore = true" :disabled="!isAnythingSelected()">
                <i class="fa fa-repeat"></i> Restore {{ numberSelected() }} selected
              </button>
            </div>
          </div>
          <div class="col-3">

            ...
            <form novalidate>
              <div class="row connection">
                ...
                <div class="col-7 form-group">
                  <label for="serviceControlUrl">CONNECTION URL
                    <template v-if="connectionState.unableToConnect">
                      <span class="failed-validation">
                        <i class="fa fa-exclamation-triangle"></i> Unable to connect
                      </span>
                    </template>
                  </label>
                ...
                <div class="col-5 no-side-padding">
                  <button class="btn btn-default btn-secondary btn-connection-test" :class="{ disabled: !configuredServiceControlUrl }" type="button" @click="testServiceControlUrl">
                    Test
                  </button>
                  <span class="connection-test connection-testing" v-if="testingServiceControl">
                    <i class="glyphicon glyphicon-refresh rotate"></i>Testing
                  </span>
                  <span class="connection-test connection-successful" v-if="serviceControlValid === true && !testingServiceControl">
                    <i class="fa fa-check"></i> Connection successful
                  </span>
                  <span class="connection-test connection-failed" v-if="serviceControlValid === false && !testingServiceControl">
              ...
              <div class="row connection">
                ...
                <div class="col-7 form-group">
                  <label for="monitoringUrl">CONNECTION URL
                ...
                <div class="col-5 no-side-padding">
                  <button class="btn btn-default btn-secondary btn-connection-test" :class="{ disabled: !configuredMonitoringUrl }" type="button" @click="testMonitoringUrl">
                    Test
                  </button>
                  <span class="connection-test connection-testing" v-if="testingMonitoring">
                    <i class="glyphicon glyphicon-refresh rotate"></i>Testing
                  </span>
                  <span class="connection-test connection-successful" v-if="monitoringValid === true && !testingMonitoring">
                    <i class="fa fa-check"></i> Connection successful
                  </span>
                  <span class="connection-test connection-failed" v-if="monitoringValid === false && !testingMonitoring">
                    <i class="fa fa-exclamation-triangle"></i> Connection failed
                  </span>
                </div>
              </div>

              <button class="btn btn-primary" type="button" @click="saveConnections">
                Save
              </button>
              <span class="connection-test connection-successful hide save-connection" v-show="connectionSaved">

...
const isUpgradeProtectionLicense = ref(useIsUpgradeProtectionLicense(license.value))
...
const upgradeDaysLeft = ref(useUpgradeDaysLeft(license.value.upgrade_protection_expiration, isValid))
const expirationDaysLeft = ref(useExpirationDaysLeft(license.value.expiration_date, isValid, isExpiring))

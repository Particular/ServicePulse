          ...
          <ul class="nav navbar-nav navbar-inverse">
              ...
              <li :class="{ active: subIsActive('/a/#/endpoints') }">
                  <a href="/a/#/endpoints">
                      ...
                      <span v-if="stats.number_of_failed_heartbeats > 0"
                            class="badge badge-important">{{ stats.number_of_failed_heartbeats }}</span>
                  </a>
              </li>
              <li :class="{
              active:
                ...
                subIsActive('/a/#/monitoring/endpoint'),
                  ...
                  <a href="/a/#/monitoring">
                      ...
                      <span v-if="stats.number_of_disconnected_endpoints > 0"
                            class="badge badge-important">{{ stats.number_of_disconnected_endpoints }}</span>
                  </a>
              </li>
              <li :class="{
              active:
                ...
                subIsActive('/a/#/failed-messages/pending-retries'),
                  ...
                  <a href="/a/#/failed-messages/groups">
                      ...
                      <span class="navbar-label">Failed Messages(Angular)</span>
                      <span v-if="stats.number_of_failed_messages > 0"
                            class="badge badge-important">{{ stats.number_of_failed_messages }}</span>
                  </a>
              </li>
              <li :class="{ active: subIsActive('/failedmessages') }">
                  <RouterLink :to="{ name: 'failedmessages' }" exact>
                      <i class="fa fa-envelope icon-white"></i>
              ...
              <li :class="{ active: subIsActive('/a/#/custom-checks') }">
                  <a href="/a/#/custom-checks">
                      ...
                      <span v-if="stats.number_of_failed_checks > 0"
                            class="badge badge-important">{{ stats.number_of_failed_checks }}</span>
                  </a>
              </li>

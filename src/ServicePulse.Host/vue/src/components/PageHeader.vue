...
import { key_License, key_UnableToConnectToServiceControl, key_UnableToConnectToMonitoring } from "./../composables/keys.js"
...
const expiredWarningType = ref(useLicenseWarningLevel(license.value.license_status))

const displayWarn = computed(() => expiredWarningType.value === "warning")
const displayDanger = computed(() => unableToConnectToServiceControl.value || unableToConnectToMonitoring.value || expiredWarningType.value === "danger")
          ...
          <ul class="nav navbar-nav navbar-inverse">
            ...
            <li :class="{ active: subIsActive('/configuration') }">
              <RouterLink :to="{name:'configuration'}" exact>
                ...
                <Exclamation :type="'warning'" v-if="displayWarn" />
                <Exclamation :type="'danger'" v-if="displayDanger" />
              </RouterLink>                
            </li>
            <li>

  ...
  <div v-if="showPagination" class="col align-self-center">
    <ul class="pagination justify-content-center">
      <li v-for="page of pages" class="page-item" :key="page.key">
        <button class="page-link" @click="pageNumber = page.page" :class="page.class" :disabled="page.class?.disabled" :aria-label="page.label" :aria-pressed="page.class?.active">{{ page.label }}</button>
      </li>
    </ul>
  </div>
</template>

          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-4 no-side-padding list-section graph-area graph-queue-length">
                ...
                <D3LargeGraph  v-if="endpoint.metricDetails.metrics.queueLength" :isdurationgraph="false" :firstdataseries="endpoint.metricDetails.metrics.queueLength" :minimumyaxis="largeGraphsMinimumYAxis.queueLength"  :plotwidth="750" :plotheight="200" :firstseriescolor="'#EA7E00'" :firstseriesfillcolor="'#EADDCE'" :avgdecimals="0"  :avglabelcolor="'#EA7E00'" :metricsuffix="'MSGS'" :csclass="'large-graph pull-left'"></D3LargeGraph>
                  <!--Queue Length-->

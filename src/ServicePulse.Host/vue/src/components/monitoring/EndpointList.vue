              ...
              <div class="col-xs-2 col-xl-1 no-side-padding">
                <div class="box-header">
                    <div class="no-side-padding">
                        ...
                        <D3Graph :type="'queue-length'" :isdurationgraph="false" :plotdata="endpoint.metrics.queueLength" :minimumyaxis="smallGraphsMinimumYAxis.queueLength" :avglabelcolor="'#EA7E00'" :metricsuffix="'MSGS'" :csclass="'graph queue-length pull-left ng-isolate-scope'"></D3Graph>
                    </div>
              ...
              <div class="col-xs-2 col-xl-1 no-side-padding">
                <div class="box-header">
                    <div class="no-side-padding">
                        ...
                        <D3Graph  :type="'throughput'" :isdurationgraph="false" :plotdata="endpoint.metrics.throughput" :minimumyaxis="smallGraphsMinimumYAxis.throughput" :avglabelcolor="'#176397'" :metricsuffix="'MSGS/S'" :csclass="'graph throughput pull-left ng-isolate-scope'"></D3Graph>
                    </div>
                  <div class="no-side-padding sparkline-value">
              ...
              <div class="col-xs-2 col-xl-1 no-side-padding">
                <div class="box-header">
                    <div class="no-side-padding">
                        ...
                        <D3Graph :type="'retries'" :isdurationgraph="false" :plotdata="endpoint.metrics.retries" :minimumyaxis="smallGraphsMinimumYAxis.retries" :avglabelcolor="'#CC1252'" :metricsuffix="'MSGS/S'" :csclass="'graph retries pull-left ng-isolate-scope'"></D3Graph>
                    </div>
                  <div class="no-side-padding sparkline-value">
              ...
              <div class="col-xs-2 col-xl-1 no-side-padding">
                <div class="box-header">
                    <div class="no-side-padding">
                        ...
                        <D3Graph  :type="'processing-time'" :isdurationgraph="true" :plotdata="endpoint.metrics.processingTime" :minimumyaxis="smallGraphsMinimumYAxis.processingTime" :avglabelcolor="'#258135'" :csclass="'graph processing-time pull-left ng-isolate-scope'"></D3Graph>
                    </div>
              ...
              <div class="col-xs-2 col-xl-1 no-side-padding">
                <div class="box-header">
                    <div class="no-side-padding">
                        ...
                        <D3Graph  :type="'critical-time'" :isdurationgraph="true" :plotdata="endpoint.metrics.criticalTime" :minimumyaxis="smallGraphsMinimumYAxis.criticalTime" :avglabelcolor="'#2700CB'" :csclass="'graph critical-time pull-left ng-isolate-scope'"></D3Graph>
                    </div>

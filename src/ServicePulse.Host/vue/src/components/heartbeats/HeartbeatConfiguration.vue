...
const { endpoints, selectedSort } = storeToRefs(store);
const sortedEndpoints = computed<Endpoint[]>(() => [...endpoints.value].sort(selectedSort.value.sort ?? getSortFunction(sortOptions[0].selector, SortDirection.Ascending)));
</script>

      ...
      children: [
        {
          ...
          path: "",
          component: () =>
            import("../components/failedmessages/FailedMessageGroups.vue"),
        },
        {
          path: "all-failed-messages",
          component: () =>
            import("../components/failedmessages/AllFailedMessages.vue"),
        },
        {
          path: "deleted-message-groups",
          component: () =>
            import("../components/failedmessages/DeletedMessageGroups.vue"),
        },
        {
          path: "all-deleted-messages",
          component: () =>
            import("../components/failedmessages/AllDeletedMessages.vue"),
        },
        {
          path: "pending-retries",
          component: () =>
            import("../components/failedmessages/PendingRetries.vue"),
        },
        {
          name: "message-groups",
          path: "group/:groupId",
      ...
      children: [
        {
          ...
          path: "",
          component: () =>
            import("../components/configuration/PlatformLicense.vue"),
        },
        {
          name: "health-check-notifications",
          path: "health-check-notifications",
          component: () =>
            import("../components/configuration/HealthCheckNotifications.vue"),
        },
        {
          name: "retry-redirects",
          path: "retry-redirects",
          component: () =>
            import("../components/configuration/RetryRedirects.vue"),
        },
        {
          name: "connections",
          path: "connections",
          component: () =>
            import("../components/configuration/PlatformConnections.vue"),
        },
        {
          name: "endpoint-connection",
          path: "endpoint-connection",
          component: () =>
            import("../components/configuration/EndpointConnection.vue"),
        },
      ],
    },
  ],

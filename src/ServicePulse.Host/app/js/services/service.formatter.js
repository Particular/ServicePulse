; (function (window, angular, undefined) {
    ...
    //for Option 6
        ...
        //for Option 8
        var secondDurationOption8 = moment.duration(0);
        var minuteDurationOption8 = moment.duration(60 * 1000);
        var hourDurationOption8 = moment.duration(24 * 60 * 60 * 1000);
        var dayDurationOption8 = moment.duration(24 * 60 * 60 * 1000);

        //for Option 9
        var secondDurationOption9 = moment.duration(1000);
        var minuteDurationOption9 = moment.duration(60 * 60 * 1000);
        var hourDurationOption9 = moment.duration(60 * 60 * 1000);

window.semverUtils = (function (module, $) {
    var my = module;
    ...
    */
    ...
    module.parse = parseSemver;
    module.stringify = stringifySemver;
    module.parseRange = parseSemverRange;
    module.stringifyRange = stringifySemverRange;

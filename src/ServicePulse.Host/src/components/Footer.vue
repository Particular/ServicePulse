...
import { key_ServiceControlUrl, key_IsSCConnected, key_IsSCConnecting, 
    key_MonitoringUrl, key_IsMonitoringEnabled, key_IsSCMonitoringConnected, key_IsSCMonitoringConnecting, 
    key_SCVersion, key_NewSCVersion, key_NewSCVersionLink, key_NewSCVersionNumber, 
    key_SPVersion, key_NewSPVersion, key_NewSPVersionLink, key_NewSPVersionNumber,
    key_MonitoringVersion, key_NewMonitoringVersion, key_NewMonitoringVersionLink, key_NewMonitoringVersionNumber,

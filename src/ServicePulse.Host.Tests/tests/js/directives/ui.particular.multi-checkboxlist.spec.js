describe('Multi checkbox list', function () {
    ...
    describe('toggle selected', function () {
        ...
        it('unselect 3 out of 5 rows using shift', function () {
            $scope.messages = [{ resolved: false, submittedForRetrial: false, selected: true, id: 1 },
                { resolved: false, submittedForRetrial: false, selected: true, id: 2 },
                { resolved: false, submittedForRetrial: false, selected: true, id: 3 },
                { resolved: false, submittedForRetrial: false, selected: true, id: 4 },
                { resolved: false, submittedForRetrial: false, selected: true, id: 5 }
            ];

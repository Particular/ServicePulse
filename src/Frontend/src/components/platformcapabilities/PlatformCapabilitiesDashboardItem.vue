  ...
  <div v-if="visibility.showSection" class="platform-capabilities">
    <div class="capabilities-header">
      <div class="capabilities-title-row">
        <div id="collapse-capabilities-btn" class="capabilities-toggle" role="button" tabindex="0" @click="platformCapabilitiesStore.toggleSection()" @keydown.enter.prevent="platformCapabilitiesStore.toggleSection()" @keydown.space.prevent="platformCapabilitiesStore.toggleSection()">
